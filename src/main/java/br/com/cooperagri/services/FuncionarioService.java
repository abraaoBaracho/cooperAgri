...
public class FuncionarioService {
   ...
   public Funcionario findById(Long id){
    ...
    return funcionarioLocalizado.orElseThrow(() -> new ResouceNotFoundException(id));
   ...
   public Funcionario create(Funcionario funcionario) {
    ...
    private void updateData(Funcionario aux, Funcionario funcionario) {
        ...
        Optional.ofNullable(funcionario.getDados_bancarios()).ifPresent(aux::setDados_bancarios);
